/**
 * VIEWMODEL: useApiUsageViewModel.js
 * Gestisce la logica per il monitoraggio delle chiamate API e le operazioni di manutenzione (reset, pulizia cache).
 */
...
export function useApiUsageViewModel(refreshRate = 2000) {
  ...
  return { usage, resetCounter, clearCache, refreshUsage: updateUsage };
}